$(window).on("load",function(){
	...
	scales:{
		...
		a={labels:["January","February","March","April","May","June","July","August","September","October","November","December"],
		datasets:[
			...
			data:[70,25,16,36,67,18,76,28,48,40,19,86],
			backgroundColor:"rgba(255,87,34,.4)",
			borderColor:"transparent",
			pointBorderColor:"#FF5722",
			ointBackgroundColor:"#FFF",
			pointBorderWidth:2,
			pointHoverBorderWidth:2,
			pointRadius:4}
		]},
